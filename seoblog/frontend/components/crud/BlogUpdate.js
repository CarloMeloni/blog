    ...
    updateBlog(formData, token, router.query.slug).then((data) => {
      if (data.error) {
        ...
        setValues({
          ...values,
          title: "",
          success: `L'articolo titolato "${data.title}" e' stato aggiornato con successo!`,
        });
        ...
        <div className="col-md-4">
          <div>
            <div className="form-group pb-2">
              ...
              <label className="btn btn-outline-danger m-3">
                Carica Immagine
                <input
