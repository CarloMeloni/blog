        ...
        <Layout>
            ...
            <section className="landing-page__cta my-10">
                <div className="landing-page__cta-item">
                    ...
                    <div className="landing-page__cta-item__text"><p>After learning JavaScript, I’ve focalised my self on React library for its lightweight and its quality to split the single-page-application in multiple components, where logic (Javascript) and JSX templates (still JavaScript but in HTML lookslike format) live together.</p></div>
                </div>
                <div className="landing-page__cta-item">
                    <div className="landing-page__cta-item__img">
