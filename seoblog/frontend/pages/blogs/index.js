...
const Blogs = ({
  ...
  const showHead = () => (
    <Head>
      ...
      <meta
        name="description"
        content="Blog contenuti tecnologia satira costume arte italian"
      />
      <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
      <meta
        property="og:title"
        content={`Questo blog puo' contenere tecnologia, satira, costume, coloranti e conservanti | ${APP_NAME}`}
      />
      <meta
